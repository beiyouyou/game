...
bool SegmentCast(const std::vector<class Actor*>& actors, const LineSegment& l, CastInfo& outInfo, Actor* ignoreActor = nullptr);
...
bool Intersect(const LineSegment& l, const class CollisionComponent* cc, float& outT, Vector3& outNorm);
